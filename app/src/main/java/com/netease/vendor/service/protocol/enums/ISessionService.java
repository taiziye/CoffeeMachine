...
public interface ISessionService {
	public interface CommandId {
		...
		public static final short CID_MASS_SAY = 13; // 群发点对点消息

		public static final short CID_ACTIVE = 20; // 正在输入
		
		public static final short CID_SAY_ACK = 50; // 单人会话消息的结果
		
		public static final short CID_SAY_MASS_ACK = 51; // 群发消息的结果
	...
	*/	
		...
		public static final int MSGID_CLIENT	 = ServiceID.SVID_SESSION << 16 | 301;  // 客户端msgid, 用于客户端去重
        ...
        public static final int LBS_COORDINATE   = ServiceID.SVID_SESSION << 16 | 500; // lbs经度纬度坐标， LBS信息与翼聊不兼容
        public static final int LBS_CONTENT		 = ServiceID.SVID_SESSION << 16 | 502; // lbs多媒体描述信息
        public static final int MSGID_SERVER	 = ServiceID.SVID_SESSION << 16 | 503; // 服务器的msg id，用于离线消息置位
	...
	public interface MessageType {
		...
		public static final int MSGTYPE_SYSINFO = 7; // 系统信息 包括网络状态等
