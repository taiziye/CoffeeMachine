...
public interface INotifyService {
	...
	public interface CommandId {
		// CTOC 表示发送方目前在线, STOC 表示发送方目前不在线.
		...
		public static final short RESET_OFFLINEMSG = 6; // 重置离线消息已接受状态未未接受
		
		public static final short GET_ALL_MOBILE  =7; //离线消息获取 聚合接口
		public static final short GET_ALL_NOTIFY  = 8; // 获取所有离线通知的返回包
		public static final short GET_ALL_MESSAGE = 9; // 获取所有离线消息的返回包
	};
}
