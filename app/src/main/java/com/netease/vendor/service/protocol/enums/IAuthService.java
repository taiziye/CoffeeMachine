...
public interface IAuthService {
	...
	public interface CommandId {
		public static final short CID_REQ_CODE = 1; // 请求验证码
		public static final short CID_VERYFI_CODE = 2; // 验证验证码
	...
	public interface KickoutReason {
		...
		public static final short Block = 2; // 被禁用
		public static final short Shutup = 3; // 被禁言
		public static final short PwdExpired = ResponseCode.RES_EUIDPASS; // 密码错，过期了？
		public static final short UserNotExist = ResponseCode.RES_ENONEXIST; // 用户不存在
		public static final short LoginError = -1; // 登录失败，未知原因
	}
	...
	public interface RequestType {
		...
		public static final int VerifyPassword = 2; // 正常情况，验证密码
	}
	
	public interface LoginRetType {
		public static final short NOTUSER = 0;  //非用户
		public static final short IAMMIXIN = 1; //普通用户
		public static final short IAMADMIN = 2; //管理员用户
	}
	...
	// 记录执行过的步骤 ,warning 翼聊版是110 ,lite版改成210
