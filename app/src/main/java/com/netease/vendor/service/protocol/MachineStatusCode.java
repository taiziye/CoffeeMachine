...
public final class MachineStatusCode {
    ...
    public static final int TIME_OUT = 619; //咖啡机在规定时间内还没做好

    public static final int MACHINE_WARM_UP = 620; //咖啡机正在预热

    public static final int ALREADY_HAVE_CUP = 621; //杯子未取走
    ...
    public static final int WASHING_MACHINE_FAILED = 633; //清洗咖啡机失败
}
